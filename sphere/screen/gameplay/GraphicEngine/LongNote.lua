...
LongGraphicalNote.getLongNoteHeadX = function(self, note)
...
LongGraphicalNote.getLongNoteTailX = function(self, note)
...
LongGraphicalNote.getLongNoteBodyX = function(self, note)
...
LongGraphicalNote.getLongNoteHeadY = function(self, note)
	local dt = note.engine.currentTime - (note:getFakeVisualStartTime() or note.startNoteData.timePoint.currentVisualTime)
	return
...
LongGraphicalNote.getLongNoteTailY = function(self, note)
	local dt = note.engine.currentTime - note.endNoteData.timePoint.currentVisualTime
	return
...
LongGraphicalNote.getLongNoteBodyY = function(self, note)
...
LongGraphicalNote.getNoteScaleX = function(self, note, part)
	if part == "Body" then
		local dt = note.engine.currentTime - note.startNoteData.timePoint.currentVisualTime
...
LongGraphicalNote.getNoteScaleY = function(self, note, part)
	if part == "Body" then
		local dt = note.engine.currentTime - note.startNoteData.timePoint.currentVisualTime
		local speedSign = sign(self.speed)
		return
...
LongGraphicalNote.whereWillLongNoteDrawX = function(self, note)
...
LongGraphicalNote.whereWillLongNoteDrawY = function(self, note)
...
LongGraphicalNote.whereWillLongNoteDraw = function(self, note)
	local x = self:whereWillLongNoteDrawX(note)
	local y = self:whereWillLongNoteDrawY(note)
	return x, y
end
LongGraphicalNote.willLongNoteDraw = function(self, note)
	local x, y = self:whereWillLongNoteDraw(note)
	return x == 0 and y == 0
end
LongGraphicalNote.willLongNoteDrawBeforeStart = function(self, note)
	local x, y = self:whereWillLongNoteDraw(note)
	local dt = note.engine.currentTime - note.startNoteData.timePoint.currentVisualTime
	local speedSign = sign(self.speed)
	return
...
LongGraphicalNote.willLongNoteDrawAfterEnd = function(self, note)
	local x, y = self:whereWillLongNoteDraw(note)
	local dt = note.engine.currentTime - note.startNoteData.timePoint.currentVisualTime
	local speedSign = sign(self.speed)
	return
...
LongGraphicalNote.getLongNoteColor = function(self, note)
